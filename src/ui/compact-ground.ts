...
export function setupCompactGround(openRemoteCockpit: () => void) {
  ...
  const hangar = document.createElement("img");
  hangar.className = "aircraft-hangar-surround";
  hangar.src = new URL("./aircraft-hangar.svg", import.meta.url).href;
  hangar.alt = ""; hangar.setAttribute("aria-hidden", "true");
  el("ground-aircraft-preview").append(hangar);
